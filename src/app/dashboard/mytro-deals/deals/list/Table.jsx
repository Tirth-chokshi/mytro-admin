...
const dealsData = [
  ...
  {
    id: 12,
    title: "Affordable Delivery Charges & Mediclaim Available",
    active: true,
  },
          ...
          <TableBody>
            {dealsData.map((deal) => (
              <TableRow key={deal.id}>
                ...
                <TableCell>
                  <Link
                    href={`/dashboard/mytro-deals/shops/list/${deal.id}`}
                    className="flex items-center space-x-1 text-teal-500 hover:text-teal-600"
                  >
